                ...
                <Modal.Body>
                    <form>
                        <div className="row">
                            ...
                            <div className="col">
                            <label className="form-label mb-2">
                                Gasas Limpias <span className="text-danger">*</span>
                            </label>
                            <div className="form-check form-switch d-flex align-items-center">
                                ...
                                />
                                <span className="ms-2">
                                    {registerFormik.values.gasas_limpias ? "✅" : "❌"}
                                </span>
                            </div>
                            {registerFormik.errors.gasas_limpias && registerFormik.touched.gasas_limpias && (
                                <div className="text-danger text-[13px]">
                                    <i className="ki-filled ki-information me-1"></i>
                        ...
                        <div className="col">
                            <label className="form-label mb-2">
                                Esparadrapo De Tela <span className="text-danger">*</span>
                            </label>
                            <div className="form-check form-switch d-flex align-items-center">
                                <input
                                ...
                                />
                                <span className="ms-2">
                                    {registerFormik.values.esparadrapo_tela ? "✅" : "❌"}
                                </span>
                            </div>
                            {registerFormik.errors.esparadrapo_tela && registerFormik.touched.esparadrapo_tela && (
                                <div className="text-danger text-[13px]">
                                    <i className="ki-filled ki-information me-1"></i>
                        ...
                        <div className="row mt-3">
                            <div className="col">
                                ...
                                <div className="form-check form-switch d-flex align-items-center">
                                    ...
                                    />
                                    <span className="ms-2">
                                        {registerFormik.values.baja_lenguas ? "✅" : "❌"}
                                    </span>
                                </div>
                            ...
                            <div className="col">
                                ...
                                <div className="form-check form-switch d-flex align-items-center">
                                    ...
                                    />
                                    <span className="ms-2">
                                        {registerFormik.values.guantes_latex ? "✅" : "❌"}
                                    </span> 
                                </div>
                            ...
                            <div className="col">
                                ...
                                <div className="form-switch form-check form-switch d-flex align-items-center">
                                    <input
                                    ...
                                    />
                                    <span className="ms-2">
                                        {registerFormik.values.venda_elastica_2 ? "✅" : "❌"}
                                    </span>
                                </div>
                        ...
                        <div className="row mt-3">
                            <div className="col">
                                ...
                                <div className="form-switch form-check form-switch d-flex align-items-center">
                                    ...
                                    />
                                    <span className="ms-2">
                                        {registerFormik.values.venda_elastica_3 ? "✅" : "❌"}
                                    </span>
                                </div>
                            ...
                            <div className="col">
                                ...
                                <div className="form-switch form-check form-switch d-flex align-items-center">
                                    ...
                                    />
                                    <span className="ms-2">
                                        {registerFormik.values.venda_elastica_5 ? "✅" : "❌"}
                                    </span>
                                </div>
                            ...
                            <div className="col">
                                ...
                                <div className="form-switch form-check form-switch d-flex align-items-center">
                                    ...
                                    />
                                    <span className="ms-2">
                                        {registerFormik.values.venda_algodon ? "✅" : "❌"}
                                    </span>
                                </div>
