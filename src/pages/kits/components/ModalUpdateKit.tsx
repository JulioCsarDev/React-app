...
interface Props {
    kit: KitUpdateKitModel | null;
    isOpen: boolean;
    setIsOpen: (isOpen: boolean) => void;
}

export const ModalUpdateKit = ({ kit, isOpen, setIsOpen }: Props) => {
    const { mutate: updateMutate } = useUpdateKit();
    ...
    const updateFormik = useFormik({
        initialValues: {
            id_insppeccion_kit: kit?.id_insppeccion_kit || 0,
            placa_vehiculo: kit?.placa_vehiculo || '',
            gasas_limpias: kit?.gasas_limpias || false,
            esparadrapo_tela: kit?.esparadrapo_tela || false,
            baja_lenguas: kit?.baja_lenguas || false,
            guantes_latex: kit?.guantes_latex || false,
            venda_elastica_2: kit?.venda_elastica_2 || false,
            venda_elastica_3: kit?.venda_elastica_3 || false,
            venda_elastica_5: kit?.venda_elastica_5 || false,
            venda_algodon: kit?.venda_algodon || false,
            yodopovidona: kit?.yodopovidona || false,
            solucion_salina: kit?.solucion_salina || false,
            termometro_digital: kit?.termometro_digital || false,
            alcohol_antiseptico: kit?.alcohol_antiseptico || false,
            botella_agua: kit?.botella_agua || false,
            bandas_adhesivas: kit?.bandas_adhesivas || false,
            tijeras_punta_roma: kit?.tijeras_punta_roma || false,
            pito_emergencias: kit?.pito_emergencias || false,
            manual_primeros_auxilios: kit?.manual_primeros_auxilios || false,
            observacion: kit?.observacion || '',
        },
        ...
        <>
            <Modal size="lg" show={isOpen} onHide={() => setIsOpen(false)}>
                <Modal.Header closeButton>
                    <Modal.Title>Actualizar Kit</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <form onSubmit={(e) => {
                        e.preventDefault();
