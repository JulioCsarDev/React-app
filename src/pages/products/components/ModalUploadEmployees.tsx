            ...
            <div className="row">
              <div className="col">
                ...
                <input
                  ...
                  className={`form-control ${
                    updateFormik.errors.CC && updateFormik.touched.CC
                      ? "border-danger"
                      : ""
                  }`}
                  placeholder="Cedula"
              ...
              <div className="col">
                ...
                <input
                  name="NOM"
                  className={`form-control ${
                    updateFormik.errors.NOM && updateFormik.touched.NOM
                      ? "border-danger"
                      : ""
                  }`}
                  placeholder="Nombre"
            ...
            <div className="row py-2">
              <div className="col">
                ...
                <input
                  name="CAR"
                  className={`form-control ${
                    updateFormik.errors.CAR && updateFormik.touched.CAR
                      ? "border-danger"
                      : ""
                  }`}
                  placeholder="Cargo"
              ...
              <div className="col">
                ...
                <input
                  name="CENTRO"
                  className={`form-control ${
                    updateFormik.errors.CENTRO && updateFormik.touched.CENTRO
                      ? "border-danger"
                      : ""
                  }`}
                  placeholder="Centro"
